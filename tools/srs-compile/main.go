...
func downgradeRuleSetVersion(version uint8, ruleSet option.PlainRuleSet) uint8 {
	if version == constant.RuleSetVersion4 && !hasHeadlessRule(ruleSet.Rules, func(rule option.DefaultHeadlessRule) bool {
	...
	if version == constant.RuleSetVersion3 && !hasHeadlessRule(ruleSet.Rules, func(rule option.DefaultHeadlessRule) bool {
